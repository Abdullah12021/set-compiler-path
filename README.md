...
**Download the script** and **Navigate to the folder** where you downloaded the script (usually `Downloads`) and run it:
...
**Close your current PowerShell window FIRST!!**, and open a brand new one to apply the changes. Test the compiler by typing:
